...
net = cv2.dnn.readNet("yolov4-custom.cfg","yolov4-custom_last.weights")
...
classification_model = load_model('traffic_recognition.h5') #load mask detection model
